...
export function tmpDirSyncFactory(user : UserContext = {}) : ImplementationDocType {
	const project = {
	...
	return function tmpDirSync(...args: Parameters<ImplementationDocType>) : ReturnType<ImplementationDocType> {
